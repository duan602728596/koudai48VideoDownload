        ...
        return (
            <tr key={ index }>
              ...
              <td>
                ...
                <button className="btn btn-default btn-sm index-mLeft" type="button"
        ...
        <div>
          ...
          <header className="bg-warning index-tools clearfix">
            ...
            <div className="pull-right">
              ...
              <button className="btn btn-default index-mLeft" type="button"
                      onClick={ this.reloadReviewList.bind(this) }>
